...
export const diets = [
    {
        name: "Vegan",
        description: "A vegan diet is a diet that excludes meat, eggs, dairy products and all other animal-derived ingredients."
    },
    {
        name: "Vegetarian",
        description: "A vegetarian diet is a diet that excludes meat, fish, and poultry, but includes eggs and dairy products."
    },
    {
        name: "Pescetarian",
        description: "A pescetarian diet is a diet that includes fish, but excludes meat, eggs, and dairy products."
    },
    { name: "Ketogenic", description: "A ketogenic diet is a very low-carb diet with numerous health benefits." },
    {
        name: "Paleo",
...
export default function AboutDiets() {
    ...
    return (
        <div className="p-6" role="main">
            ...
            <div className="flex flex-col gap-12 border-t-2" role="list">
                {diets.map((diet) => {
                    return (
