...
export default function AboutDiets() {
    const diets = [
        ...
        { name: "Vegetarian", description: "A vegetarian diet is a diet that excludes meat, fish, and poultry, but includes eggs and dairy products." },
        { name: "Pescetarian", description: "A pescetarian diet is a diet that includes fish, but excludes meat, eggs, and dairy products." },
