...
export default function MealPlanner() {
    ...
    return (
        <div className="px-3">
            <h1 className="my-6 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white mb-12">Plan your meal for next day or week</h1>
            <div className="w-[40%] mr-auto">
                <Select onChange={onChangeTimeframe} label={"Choose timeframe"} id={"timeframe"}
                        options={["1 day", "1 week"]}/>
                <Select onChange={onChangeDiet} label={"Choose diet"} id={"diet"}
                        options={["Vegan", "Vegetarian", "Pescatarian", "Ketogenic", "Paleo", "Primal", "Whole30", "Low FODMAP"]}/>
                <Select onChange={onChangeCalories} label={"Choose calories"} id={"calories"}
