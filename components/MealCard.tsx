    ...
    return (
        <div className="max-w-sm">
            ...
            >
                ...
                <div className="mt-2.5 mb-5 flex items-center">
                    ...
                    <div className="flex flex-wrap gap-1 max-w-sm w-[40%]">
      ...
      <span className="text-2xl font-bold text-gray-900 dark:text-white">
        {mealInfo.missedIngredientCount} missing ingredients
                    ...
                    <a
                        href="#"
                        className="rounded-lg bg-blue-700 ml-2 px-4 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Check details
                    </a>
                    <a
