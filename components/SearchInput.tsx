            ...
            <form onSubmit={onSubmitForm} className="px-3">
                <div className="flex">
                    <label htmlFor="search-dropdown"
                           className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-gray-300">Your meal
                        ingredients</label>
                    ...
                    <div className="relative w-full">
                        ...
                        <Input
                            className="block p-4 w-full z-20 text-md text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
                            onChange={handleSearch} value={search} type="search" id="search-dropdown" ref={inputRef}
                            placeholder={"Ingredients..."}/>
                        <button type="submit"
                                className="absolute top-0 right-0 bottom-0 p-3.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
